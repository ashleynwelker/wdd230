...
const weatherAPI = "https://api.openweathermap.org/data/2.5/weather?id=5604473&units=imperial&appid=3d14e82cac088b47e97b083c06681a11";
fetch(weatherAPI)
...
const forecastAPI = "https://api.openweathermap.org/data/2.5/forecast?id=5604473&units=imperial&appid=3d14e82cac088b47e97b083c06681a11";
fetch(forecastAPI)
  .then((response) => response.json())
  .then((forecastData) => {
